...
export class SceneContainer extends Component {
    ...
    componentDidUpdate() {
        ...
        document.title = "Info 6215 Project Midterm";

        this._getData();
        console.log(djson);

        console.log("in scenes");
      ...
      //  _getConsole();
        ...
        for(let value in this.state.data){
                if(value.scene==="scene1"){
                     text1=value.text;
                    console.log(value.text)
                    console.log("this is what is!!!")
                }
            }
...
//    _getConsole(){
//    return Object.keys(this.state.data.json(function(key) {
//                let text1=this.state.data.json[key]
//                
//                console.log(text1 + "is what you get man !!!!!")
//                }));
//        }

    // getting data from API 
    _getData() {
        return axios.get('https://localhost:44368/api/username', {
                method: 'GET',
                mode: 'no-cors',
                headers: {
...
//                })
                  ...
                  setTimeout(() => {this.setState({data: response.data}, function(){
    ...
    render() {
        ...
        return ( < StyledBox className = "SceneContainer" >
            <
            MainTitle text = {
                (!noLevelPresent) ? presentLevel.loadLevel(this.props.game) : '.....'
            }
            /> <
            GameFullText id = "text-img"
            noLevelPresent = {
                noLevelPresent
            }
            game = {
            ...
            /> <
            ButtonsContainer noLevelPresent = {
                noLevelPresent
            }
            game = {
                this.props.game
...
export var Scenes = {
    ...
    Cave: new Scene('Cave', (game) => {
        if (game.race === "Undead") {
            ...
            //console.log(text1 + "  is the name");
          let text2 = "You wake up in a dark cave, your eternal resting place. Your resurrection is the result of some unfinished business, as it always is with the Undead.";
            return text2;
        } else {
